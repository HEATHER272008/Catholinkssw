      ...
      <div className="min-h-screen gradient-bg p-4 md:p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-6">
            <CrossLogo size={60} />
            <h1 className="text-2xl font-bold mt-3">Attendance Summary</h1>
            <p className="text-sm text-muted-foreground">Your complete attendance overview</p>
          </div>
                ...
                <Card className="shadow-sm">
                  <CardContent className="p-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Morning Attended</p>
                    </div>
                  </CardContent>
                </Card>
                <Card className="shadow-sm">
                  <CardContent className="p-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Afternoon Attended</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="text-center py-3 px-2 font-medium text-muted-foreground">Period</th>
